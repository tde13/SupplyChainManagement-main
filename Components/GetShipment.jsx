...
const getShipmentData = async () => {
  if (!indexInput.trim()) {
    setErrorMessage("Enter a shipment index.");
  ...
  try {
    const getData = await getShipment(parsedIndex);
    if (!getData || !getData.sender) {
      setErrorMessage("Shipment not found. Verify the index.");
      setSingleShipmentData(null);
      return;
    }
    ...
    setErrorMessage("Unable to fetch shipment. Check the index and try again.");
    setSingleShipmentData(null);
  }
};
